...
%PAKPACK% replace "%INPUT_PATH%\field\pack\F007_001.P00" f007.bf "%OUTPUT_PATH%\field\pack\fd007_001\f007.bf" "%OUTPUT_PATH%\DATA\FIELD\PACK\F007_001.P00"
%PAKPACK% replace "%INPUT_PATH%\field\pack\F010_002.P00" f010.bf "%OUTPUT_PATH%\field\pack\fd010_002\f010.bf" "%OUTPUT_PATH%\DATA\FIELD\PACK\F010_002.P00"
%PAKPACK% replace "%INPUT_PATH%\field\pack\F020_001.P00" f020.bf "%OUTPUT_PATH%\field\pack\fd020_001\f020.bf" "%OUTPUT_PATH%\DATA\FIELD\PACK\F020_001.P00"
%PAKPACK% replace "%INPUT_PATH%\field\pack\F023_001.P00" f023.bf "%OUTPUT_PATH%\field\pack\fd023_001\f023.bf" "%OUTPUT_PATH%\DATA\FIELD\PACK\F023_001.P00"
